...
/*
    if(isset($_SESSION['username']) && !empty($_SESSION['username']))
    {
        echo '<a class="active" onclick="document.getElementById('id03').style.display='block'" style="float:left; color: white; text-align: center; padding: 12px; text-decoration: none; font-size: 18px; line-height: 25px; border-radius: 4px;" href="indexTesting.php">Logout</a>';
    }
 */
?>
